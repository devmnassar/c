...
class OnboardingState extends ChangeNotifier {
  ...
  static const _kWelcomeEntered = 'welcomeEntered';
  ...
  bool get welcomeEntered => _welcomeEntered;
  ...
  Future<void> _load() async {
    ...
    _welcomeEntered = await SharedPrefHelper.getBool(_kWelcomeEntered);
    _loaded = true;
  }
  ...
  Future<void> setWelcomeEntered(bool value) async {
    await ensureLoaded();
    if (_welcomeEntered == value) return;
    _welcomeEntered = value;
    await SharedPrefHelper.setData(_kWelcomeEntered, value);
    notifyListeners();
  }
  ...
  Future<void> logout() async {
    ...
    _locationServiceEnabled = false;
    _profileCompleted = false;
    _welcomeEntered = false;
    await SharedPrefHelper.setData(_kIsLoggedIn, false);
    await SharedPrefHelper.setData(_kPermissionsGranted, false);
    await SharedPrefHelper.setData(_kLocationServiceEnabled, false);
    await SharedPrefHelper.setData(_kProfileCompleted, false);
    await SharedPrefHelper.setData(_kWelcomeEntered, false);
