    ...
    if (kIsWeb) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              AppLocalizations.of(context)?.openSettings ?? 'Please enable location in your browser settings',
            ),
          ),
        );
      }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isPermanentlyDenied
                  ? (l10n?.permissionPermanentlyDenied ?? 'Permission Permanently Denied')
            ...
            const SizedBox(height: 48),
            FilledButton(
              onPressed: isPermanentlyDenied ? _openSettings : _requestPermission,
              style: FilledButton.styleFrom(
                minimumSize: const Size(double.infinity, 50),
              ),
              child: Text(
