    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          enabled: enabled,
          readOnly: readOnly,
          enableInteractiveSelection: isSensitive ? false : !obscureText,
          enableSuggestions: isSensitive ? false : !obscureText,
          autocorrect: isSensitive ? false : !obscureText,
          contextMenuBuilder:
              isSensitive ? (_, __) => const SizedBox.shrink() : null,
