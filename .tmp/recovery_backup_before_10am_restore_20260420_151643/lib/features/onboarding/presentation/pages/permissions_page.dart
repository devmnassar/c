...
class _PermissionsPageState extends State<PermissionsPage> {
  ...
  String _getStatusText(AppLocalizations? l10n, PermissionStatus status) {
    switch (status) {
      case PermissionStatus.granted:
        return l10n?.permissionGranted ?? 'Granted';
      case PermissionStatus.denied:
      case PermissionStatus.permanentlyDenied:
        return l10n?.permissionDenied ?? 'Denied';
      case PermissionStatus.notRequested:
        return l10n?.permissionNotRequested ?? 'Not requested';
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l10n?.permissionsTitle ?? 'App Permissions')),
      body: SafeArea(
        child: Column(
          children: [
            // Stepper header
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    l10n?.permissionsTitle ?? 'App Permissions',
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 52,
                    child: FilledButton(
                      onPressed: _loading ? null : _requestAllPermissions,
                      ...
                      child: _loading
                          ...
                          : Text(
                              l10n?.allowAndContinue ?? 'Allow & Continue',
  ...
  String _getLocalizedString(AppLocalizations? l10n, String key) {
    switch (key) {
      case 'locationPermissionName':
        return l10n?.locationPermissionName ?? 'Location';
      case 'locationPermissionDesc':
        return l10n?.locationPermissionDesc ??
            'Track your location for accurate delivery tracking';
      case 'cameraPermissionName':
        return l10n?.cameraPermissionName ?? 'Camera';
      case 'cameraPermissionDesc':
        return l10n?.cameraPermissionDesc ??
            'Take photos of deliveries and documents';
      case 'contactsPermissionName':
        return l10n?.contactsPermissionName ?? 'Contacts';
      case 'contactsPermissionDesc':
        return l10n?.contactsPermissionDesc ?? 'Quick contact with customers';
      case 'notificationsPermissionName':
        return l10n?.notificationsPermissionName ?? 'Notifications';
      case 'notificationsPermissionDesc':
        return l10n?.notificationsPermissionDesc ??
