...
IncomingOrderMock fromOrderMock(OrderMock order) {
  ...
  final laundryLatLng =
      const LatLngMock(24.7136, 46.6753); // Mock laundry coords
  ...
  final addressLine2Laundry =
      '$laundryName Branch, Prince Sultan St, Riyadh, Saudi Arabia';
