...
class OtpVerificationPage extends StatelessWidget {
  ...
  const OtpVerificationPage({
    ...
    this.nextRoute = '/signup/documents',
  });
...
class SignUpOtpVerificationPage extends OtpVerificationPage {
  static const String id = OtpVerificationPage.id;

  const SignUpOtpVerificationPage({
    super.key,
    required super.phoneNumber,
    super.nextRoute = '/signup/documents',
  });
}
