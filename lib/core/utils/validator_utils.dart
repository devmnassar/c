...
class AppValidators {
  ...
  static String? name(
    ...
    bool required = true,
    int minLength = 2,
    String requiredMessage = ValidationMessages.nameRequired,
    String invalidMessage = ValidationMessages.nameInvalid,
    String minLengthMessage = ValidationMessages.nameTooShort,
  }) {
    ...
    final pattern = RegExp(r"^[a-zA-Z\s\u0621-\u064A]+$");
  ...
  static String? password(
    ...
    String requiredMessage = ValidationMessages.passwordRequired,
    String minLengthMessage = ValidationMessages.passwordTooShort,
    String? maxLengthMessage,
    String uppercaseMessage = ValidationMessages.passwordUppercaseRequired,
    String lowercaseMessage = ValidationMessages.passwordLowercaseRequired,
    String digitMessage = ValidationMessages.passwordNumberRequired,
    String specialCharMessage = ValidationMessages.passwordSpecialCharRequired,
...
class Validators extends AppValidators {
  ...
  static FieldValidator passwordValidatorWithOptions({
    bool required = true,
    int minLength = 8,
    int? maxLength,
    bool requireUppercase = true,
    ...
    return (value) => AppValidators.password(
          value,
          required: required,
          minLength: minLength,
          maxLength: maxLength,
  ...
  static FieldValidator confirmPasswordValidator({
    required String Function() passwordValue,
    bool required = true,
    int minLength = 8,
    int? maxLength,
    bool requireUppercase = true,
    ...
    return (value) => AppValidators.confirmPassword(
          value,
  ...
  static FieldValidator phoneNumberValidatorWithOptions({
    String? isoCode,
    PhoneRegion region = PhoneRegion.auto,
    bool required = true,
    bool allowPlusPrefix = true,
    ...
    int minInternationalDigits = 8,
    int maxInternationalDigits = 15,
    String requiredMessage = ValidationMessages.phoneRequired,
    String invalidMessage = ValidationMessages.phoneInvalid,
    String? saudiInvalidMessage,
  }) {
    return (value) => AppValidators.phone(
          value,
          isoCode: isoCode,
          region: region,
          required: required,
          allowPlusPrefix: allowPlusPrefix,
          allowSaudiLeadingZero: allowSaudiLeadingZero,
          allowSaudiCountryCode: allowSaudiCountryCode,
          minInternationalDigits: minInternationalDigits,
          maxInternationalDigits: maxInternationalDigits,
          requiredMessage: requiredMessage,
          invalidMessage: invalidMessage,
          saudiInvalidMessage: saudiInvalidMessage,
        );
  }
}
