...
class SignUpCubit extends Cubit<SignUpState> {
  ...
  String? nameValidator(String? value) => Validators.nameValidator(value);

  String? emailValidator(String? value) => Validators.emailValidator(value);
  ...
  String? phoneValidator(String? value) {
    final isoCode = state.initialPhoneNumber?.isoCode?.toUpperCase();
    return Validators.phoneNumberValidatorWithOptions(
      isoCode: isoCode,
    )(value);
  }
